    ...
    class Model():
        def __init__(self,
            ...
            with tf.device('/cpu:0'), tf.name_scope("word_embedding_layer"):
                ...
                W_text = tf.Variable(tf.random_normal(shape=[vocab_size, word_embedding_size], mean=0.0, stddev=0.5),
                                     name="word_table")
            ...
            with tf.device('/cpu:0'), tf.name_scope('softmax'):
                W = tf.Variable(
                    tf.truncated_normal([num_filters_total + sentence_length * word_embedding_size, num_labels],
                                        stddev=0.1), name="W")
        ...
        with sess.as_default():
            ...
            for epoch in range(num_epochs):
                ...
                if epoch % 3 == 0:
                    ...
                    eval_step(input_x=x, input_y=y, input_t=t, input_c=c, input_c_pos=pos_c, input_t_pos=pos_t,
